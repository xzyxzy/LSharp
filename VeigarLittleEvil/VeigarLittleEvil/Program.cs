    ...
    class Program
    {
        ...
        public static void lastHit()
        {
            ...
            if (Q.IsReady())
            {
                ...
                {
                    if (minion.IsValidTarget() && HealthPrediction.GetHealthPrediction(minion, (int)(Player.Distance(minion) * 1000 / 1100), 130) < Damage.GetSpellDamage(Player, minion, SpellSlot.Q) - 25)
                    {
                        if (Q.IsReady())
                        {

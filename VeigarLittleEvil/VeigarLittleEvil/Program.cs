    ...
    class Program
    {
        ...
        public static void lastHit()
        {
            ...
            if (Q.IsReady())
            {
                ...
                {
                    if (minion.IsValidTarget() && HealthPrediction.GetHealthPrediction(minion, (int)(Player.Distance(minion) * 1000 / 1400)) < Damage.GetSpellDamage(Player, minion, SpellSlot.Q) - 15)
                    {
                        if (Q.IsReady())
                        {
